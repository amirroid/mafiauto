...
object Strings {
    ...
    val endResult = Res.string.end_result
    val gameWinnerAnnouncement = Res.string.game_winner_announcement
    ...
    val fontScale = Res.string.font_scale
    ...
    val noGroupssMessage = Res.string.no_groups_message
    ...
    val civilianExplanation = Res.string.civilian_explanation
    val sniperExplanation = Res.string.sniper_explanation
    val silencerExplanation = Res.string.silencer_explanation
